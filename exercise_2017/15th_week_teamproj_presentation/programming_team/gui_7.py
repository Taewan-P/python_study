...
class App(Frame):
	...
	def create_widgets(self):
		...
		Button(self, text="Hard", command=self.hard_select, width = 10, height = 5, justify=CENTER).grid(row = 2, column = 0)
		Button(self, text="Normal", command=self.normal_select, width = 10, height = 5, justify=CENTER).grid(row = 3, column = 0)
		Button(self, text="Easy", command=self.easy_select, width = 10, height = 5, justify=CENTER).grid(row = 4, column=0)
