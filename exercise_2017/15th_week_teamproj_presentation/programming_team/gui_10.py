...
class StopWatch(Frame):  
	...
	def completebox(self, hours, minutes, seconds):
		""" Shows when the sudoku puzzle is done."""
		messagebox.showinfo("Complete!!\n", "It took "+str(hours)+" hours, "+str(minutes)+" minutes, "+\
							str(seconds)+" seconds for you to solve this sudoku.\n"+\
...
class App_H(Frame):
		...
		for i in range(9):
			for j in range(9):
				if self.enlist_int[i][j]!=self.enlist_tmp[i][j]:
					if self.enlist_int[i][j]!=self.hsb[i][j] and str(self.enlist_tmp[i][j]).isdigit() and (self.enlist_tmp[i][j]<=0 or self.enlist_tmp[i][j]>10):
	...
	# 				if self.enlist_int[i][j]==self.enlist_tmp[i][j]:
	# 					if self.enlist_int[i][j]==self.hsb[i][j]:
	# 						messagebox.showinfo("Right Answer", "Oh! It's right number. Congratulations.")
...
class App_N(Frame):
	...
	def submit(self):
		...
		for i in range(9):
			for j in range(9):
				if self.enlist_int[i][j]!=self.enlist_tmp[i][j]:
					if self.enlist_int[i][j]!=self.nsb[i][j] and str(enlist_int[i][j].isdigit()) and (enlist_int[i][j]<=0 or enlist_int[i][j]>10):
						messagebox.showinfo("Wrong Answer", "Oh! It's worng number. HAHAHAHAHAHAHAHA! Try Again.")
...
class App_E(Frame):
	...
	def submit(self):
		...
		for i in range(9):
			for j in range(9):
				if self.enlist_int[i][j]!=self.enlist_tmp[i][j]:
					if self.enlist_int[i][j]!=self.esb[i][j] and str(enlist_int[i][j].isdigit()) and (enlist_int[i][j]<=0 or enlist_int[i][j]>10):
						messagebox.showinfo("Wrong Answer", "Oh! It's worng number. HAHAHAHAHAHAHAHA! Try Again.")
