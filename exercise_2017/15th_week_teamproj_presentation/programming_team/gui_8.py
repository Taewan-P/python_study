...
class App(Frame):
	...
	def create_widgets(self):
		...
		# Button(self)(text="Hard", fg = 'red', width = 10, height = 5, justify=CENTER).grid(row = 2, column = 0)
		# Button(self)(text="Normal", fg = 'orange', width = 10, height = 5, justify=CENTER).grid(row = 3, column = 0)
		# Button(self)(text="Easy", fg = 'green', width = 10, height = 5, justify=CENTER).grid(row = 4, column=0)
