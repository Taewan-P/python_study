...
class Box:
    ...
    def ball_contact(self,x,y): #가로 세로 쪼개는 중
...
class MovingBall:
    ...
    def move(self, time_unit):
        ...
        if self.box.ball_contact(self.x,self.y):
            ...
            if (180<=self.x<=220 and  175 <=self.y <= 185) or (180<=self.x<=220 and 215<=self.y <= 225): #세로조건
                self.yv = -self.yv
            
            if (180<=self.y<=220 and 175 <=self.x <= 185) or (180<=self.y<=220 and  215<= self.x <= 220): #가로조건
                self.xv = -self.xv         

            
#######################
            # if (180<=self.x<=220 and self.y == 180):  #세로조건
            #     self.yv = -self.yv

            # if (180<=self.x<=220 and self.y == 220):
            #     self.yv = -self.yv
            
            # if (180<=self.y<=220 and self.x == 180) :
            #     self.xv = -self.xv
            # if (180<=self.y<=220 and self.x == 220): #가로조건
            #     self.xv = -self.xv
