...
class App(Frame): 
    ...
    def create_widgets(self): 
        ...
        Checkbutton(self, text="Lager", variable=self.lagers).grid(row=4, column=0) 
        self.wheetbeer = BooleanVar()             
        Checkbutton(self, text="Wheet Beer", variable=self.wheetbeer).grid(row=4, column=1) 
        self.pilsners = BooleanVar() 
        Checkbutton(self, text="Pilsner", variable=self.pilsners).grid(row=4, column=2) 
        self.paleales = BooleanVar() 
        Checkbutton(self, text="Pale Ale", variable=self.paleales).grid(row=5, column=0) 
        self.indiapaleales = BooleanVar() 
        Checkbutton(self, text="India Pale Ale", variable=self.indiapaleales).grid(row=5, column=1) 
        self.stouts = BooleanVar() 
        Checkbutton(self, text="Stout", variable=self.stouts).grid(row=5, column=2)
